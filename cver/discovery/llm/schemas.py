    ...
    "properties": {
        "hypotheses": {
            ...
            "items": {
                ...
                "additionalProperties": False,
                "required": [
                    "title", "root_cause_l1", "root_cause_l2", "security_boundary",
                    "invariant", "rationale", "confidence", "experiment_kinds",
                    "known_cve_candidates",
                ],
                "properties": {
                    "title": {"type": "string", "minLength": 1, "maxLength": 240},
                    "root_cause_l1": {"type": "string", "minLength": 1, "maxLength": 120},
                    "root_cause_l2": {"type": "string", "minLength": 1, "maxLength": 160},
                    ...
                    "experiment_kinds": {
                        ...
                        "items": {
                            "type": "string",
                            "enum": [
                                "version_check", "semgrep_scan", "go_test", "go_fuzz",
                                "patch_diff", "synthetic_fixture", "tracee_observe",
                            ],
                        },
                    },
                    "known_cve_candidates": {
...
CRITIC_SCHEMA: dict[str, Any] = {
    ...
    "properties": {
        ...
        "next_experiments": {
            ...
            "items": {
                "type": "string",
                "enum": ["version_check", "semgrep_scan", "go_test", "go_fuzz", "patch_diff", "synthetic_fixture", "tracee_observe"],
            },
            "maxItems": 10,
        },
        "recommended_stage": {
